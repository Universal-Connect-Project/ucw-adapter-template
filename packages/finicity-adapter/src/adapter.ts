...
//     const { finicityProd, finicitySandbox, sessionId, storageClient } = config;
//     this.sessionId = sessionId;
//     this.cacheClient = storageClient;
...
export class FinicityAdapter implements WidgetAdapter {
  ...
  constructor(args: AdapterConfig) {
    ...
    this.apiClient = sandbox
      ? new FinicityClient(dependencies?.aggregatorCredentials.finicitySandbox, this.logger, this.envConfig)
      : new FinicityClient(dependencies?.aggregatorCredentials.finicityProd, this.logger, this.envConfig);
  }
